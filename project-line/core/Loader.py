...
main_path = f.read()
f.close()
f = open(main_path + "\\userdata\\javaw.txt")
javaw_path = f.read()
f.close()
...
version = f.read()
f.close()
f = open(main_path + "\\userdata\\maxmem.txt")
maxmem = f.read()
f.close()
f = open(main_path + "\\userdata\\usernameg.txt")
username = f.read()
f.close()
...
f = open(main_path + "\\userdata\\logincategory.txt")
